    ...
    std::vector<DualReal> & eigvals, RankTwoTensorTempl<DualReal> & eigvecs) const
{
  eigvecs = *this;
  eigvals.resize(N);
  std::vector<DualReal> e(N);

  tridiagonalReduction(eigvecs, eigvals, e);
  tridiagonalQLDecomposition(eigvecs, eigvals, e);
}

template <typename T>
void
RankTwoTensorTempl<T>::tridiagonalReduction(RankTwoTensorTempl<T> & V,
                                            std::vector<T> & d,
...
template <typename T>
void
RankTwoTensorTempl<T>::tridiagonalQLDecomposition(RankTwoTensorTempl<T> & V,
                                                  std::vector<T> & d,
                                                  std::vector<T> & e) const
{
