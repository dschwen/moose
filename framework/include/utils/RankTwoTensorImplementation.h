...
{
  VectorValue<T> result1;
  for (auto i : make_range(N))
    result1(i) = (*this)(i, c);
  // return result1;

  auto result2 = VectorValue<T>((*this)(0, c), (*this)(1, c), (*this)(2, c));
  // auto result2 = VectorValue<T>(_coords[c], _coords[c + N], _coords[c + 2 * N]);
  if (result1 != result2)
    mooseError(result1, result2, *this);
  return result2;
}
