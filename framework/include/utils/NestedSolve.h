...
public:
  ...
  template <typename V, typename R, typename J>
  void nonlinear(V & guess, R computeResidual, J computeJacobian);
...
template <typename V, typename R, typename J>
void
NestedSolve::nonlinear(V & guess, R computeResidual, J computeJacobian)
{
