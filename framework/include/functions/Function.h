...
public:
  ...
  U value(U t) const;
  template <typename U>
  U value(U t, U x, U y = 0, U z = 0) const;
  ///@}
  ...
  template <typename U>
  U timeDerivative(U t) const;
  template <typename U>
  U timeDerivative(U t, U x, U y = 0, U z = 0) const;
  ///@}
...
template <typename U>
U
FunctionTempl<T>::value(U t) const
{
...
template <typename U>
U
FunctionTempl<T>::value(U t, U x, U y, U z) const
{
...
template <typename U>
U
FunctionTempl<T>::timeDerivative(U t) const
{
  static const MooseADWrapper<Point, MooseIsADType<U>::value> p;
...
template <typename U>
U
FunctionTempl<T>::timeDerivative(U t, U x, U y, U z) const
{
  MooseADWrapper<Point, MooseIsADType<U>::value> p(x, y, z);
  return timeDerivative(t, p);
}
