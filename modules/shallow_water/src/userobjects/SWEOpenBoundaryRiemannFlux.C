...
SWEOpenBoundaryRiemannFlux::validParams()
{
  ...
  params.addParam<MooseEnum>("farfield_mode", farfield_mode,
                             "Farfield specification mode: stage or dry");
  params.addParam<Real>("eta_infty", 0.0,
                        "Farfield stage (eta=h+b) used when farfield_mode='stage'");
